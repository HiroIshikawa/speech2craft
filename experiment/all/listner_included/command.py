...
class DependencyPattern:
    ...
    def display(self):
        ...
        print('{} {} {} {} {} {} {}').format(self.root, self.prop, self.pobj, 
                                       self.advmod, self.acomp, self.dobj, self.iobj)
...
def parsePattern(head):
	"""Parse a dependency pattern given head of dependency
	Args:
		head (obj): spacy token object of the head of dependency to be parsed
	Returns:
		depPattern (obj): the dependency patter found 
	"""
